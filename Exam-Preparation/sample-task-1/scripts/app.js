(function () {
    require(['structures'], function (structures) {
        var bulgarianHeroesSection, greekHeroesSection, heroesContainer, superheroesSection, test, result, testResult;
        ...
        result = JSON.stringify(heroesContainer.getData());
        testResult = JSON.stringify(test);
